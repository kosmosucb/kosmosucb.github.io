...
export default function Page() {
    ...
    <main className="flex min-h-screen flex-col items-center p-8">
        ...
        <div className="mb-32 text-center grid lg:grid-cols-2 lg:mb-0 lg:w-full lg:max-w-5xl lg:text-left">
            ...
            name="Fall 2023" 
            image="/fa23team.jpg" 
            team="Roster: Abbie Tsai, Allyson Yang, Ariel Cardona, Avery Perez, Carol Chen, Cat Simmons, Celine He, Emily Luo, Fira Fatmasiefa, Hannah Chen, 
            ...
            name="Spring 2023" 
            image="/sp23team.jpg" 
            team="Roster: Abbie Tsai, Alex Rodriguez, Allyson Yang, Angelina Wang, Annie Li, Ariane Vidal, Avery Perez, Chanel Jung, Elizabeth Hung
            ...
            name="Fall 2022" 
            image="/fa22team.jpg" 
            team="Roster: Vincent Baugh, Hannah Chen, Wei-Chi Chen, Zoe Chen, Nicole Cheng, Miranda Cheung, Ingrid Chien, Jay Choi, 
            ...
            name="Spring 2022" 
            image="/sp22team.jpg" 
            team="Roster: Vincent Baugh, Allen Cao, Queeny Chan, Hannah Chen, Tiffany Chen, Nicole Cheng, Miranda Cheung, Ingrid Chien, Jay Choi, Robin Chu, Ethan Chung, Andrew Dacayanan, 
            ...
            name="Fall 2021" 
            image="/fa21team.jpg" 
            team="Roster: Alex Rodriguez, Andrew Dacayanan, Angeline Lee, Annabelle Yao, Annie Huang, Antheia Pham, Avery Perez, Carolina Rios-Martinez
